...
//	static final long serialVersionUID = 3256439218279428914L;
    ...
    public void add (Rectangle rect) {
        if (rect == null) System.out.println("Rect == null");
    ...
    public boolean contains (Point pt) {
        if (pt == null) /*SWT.error(SWT.ERROR_NULL_ARGUMENT);*/ System.out.println("pt = null");
    ...
    public void intersect (Rectangle rect) {
        if (rect == null) System.out.println("rect = null");//SWT.error(SWT.ERROR_NULL_ARGUMENT);
        if (this == rect) return;
        int left = x > rect.x ? x : rect.x;
        int top = y > rect.y ? y : rect.y;
        int lhs = x + width;
